...
import { Newline, Box, Text, measureElement } from "ink";
import PairChart from "./PairChart.jsx";
import { ConfigProvider } from "../context/config/index.js";
...
import PairDataProvider, {
  usePairData,
  useAllPairData,
  usePairChartData,
} from "../context/pairData";
import GlobalDataProvider, { useEthPrice } from "../context/globalData";

const USDETH = "0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc";
...
const Table = () => {
  ...
  const allPairData = useAllPairData(USDETH);
  // console.log(allPairData);
  const pairChartData = usePairChartData(USDETH);
